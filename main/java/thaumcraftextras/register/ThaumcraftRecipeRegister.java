...
public class ThaumcraftRecipeRegister {
	...
	ironRod = ThaumcraftApi.addArcaneCraftingRecipe("Wand Rods", new ItemStack(ItemRegister.ironRodItem), CraftingAspects.ironRod, new Object[]{
		...
		"X  ",
		'X', Item.ingotIron,
		'I', new ItemStack(ConfigItems.itemWandRod, 1, 0)});
	...
	emptyFoci = ThaumcraftApi.addArcaneCraftingRecipe("Empty Focus", new ItemStack(ItemRegister.emptyFoci, 1, 0), CraftingAspects.emptyFoci,  new Object[]{
		...
		darkSilverwoodLog = ThaumcraftApi.addShapelessArcaneCraftingRecipe("Thaumcraft Extras", 
			new ItemStack(BlockRegister.darkSilverwoodLog), new AspectList().add(Aspect.ENTROPY, 1), 
		...
		darkSilverwoodPlank = ThaumcraftApi.addShapelessArcaneCraftingRecipe("Thaumcraft Extras", 
				new ItemStack(BlockRegister.darkSilverwood , 4, 0), new AspectList().add(Aspect.ENTROPY, 1), 
		...
		GameRegistry.addShapelessRecipe(new ItemStack(Item.paper, 1, 0), ConfigItems.itemResearchNotes);
