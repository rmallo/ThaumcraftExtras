...
public class BlockRegister {
	...
	public static void load()
	{
		...
		darkSilverwood = new TCEBlock(Config.darkSilverwoodId).setUnlocalizedName(MainHelper.modName + ":" + TCELocalization.darkSilverwoodTexture);
		...
		darkSilverwoodLog = new BlockLog(Config.darkSilverwoodLogId).setUnlocalizedName(MainHelper.modName + ":" + TCELocalization.darkSilverwoodTexture);
