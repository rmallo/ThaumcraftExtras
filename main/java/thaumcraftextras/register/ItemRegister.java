...
public class ItemRegister {
	...
	{	
		...
		//customFoci = new CustomFoci(Config.customFociId).setUnlocalizedName(MainHelper.modName + ":" + TCELocalization.customFociTexture);
		//LanguageRegistry.addName(customFoci,  TCELocalization.customFoci);
        ...
        darkSilverwoodRod = new WandRod("darkSilverwood", 1000, new ItemStack(darkSilverwoodRodItem), 50,  new ResourceLocation("thaumcraftextras","textures/models/wand_rod_darksilverwood.png"));
