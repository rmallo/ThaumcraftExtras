 ...
 public void findAspect() {
	...
	*/
    ...
    public AspectList getAspects() {
            ...
            if(stack == null)
                    return null;
            else return new AspectList().add(Aspect.MAGIC, stack.getItemDamage()).add(Aspect.TREE, stack.getItemDamage()).add(Aspect.FIRE, stack.getItemDamage()).add(Aspect.ENERGY, stack.getItemDamage());
    }
