...
public class AspectRegister{
	...
	public static void addAspects()
	{
		...
		ThaumcraftApi.registerObjectTag(Config.fireBlockId, -1, new AspectList().add(Aspect.FIRE, 18));
		ThaumcraftApi.registerObjectTag(Config.airBlockId, -1, new AspectList().add(Aspect.AIR, 18));
		ThaumcraftApi.registerObjectTag(Config.waterBlockId , -1, new AspectList().add(Aspect.WATER, 18));
		ThaumcraftApi.registerObjectTag(Config.earthBlockId , -1, new AspectList().add(Aspect.EARTH, 18));
