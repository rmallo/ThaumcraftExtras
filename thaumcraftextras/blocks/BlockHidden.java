...
public class BlockHidden extends BlockContainer {
    ...
    {
            TileEntityHidden tile = (TileEntityHidden) par1World.getBlockTileEntity(par2, par3, par4);
            if(!(par7Entity instanceof EntityPlayer && ((EntityPlayer) par7Entity).username.equals(tile.getName())))
