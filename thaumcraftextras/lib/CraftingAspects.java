...
public class CraftingAspects {
	...
	public static AspectList pechTradeTier2 = new AspectList().add(Aspect.ORDER, 10);
	public static AspectList pechTradeTier3 = new AspectList().add(Aspect.ORDER, 15);
	public static AspectList pechTradeTier4 = new AspectList().add(Aspect.ORDER, 20);
	public static AspectList pechTradeTier5 = new AspectList().add(Aspect.ORDER, 25);

	public static AspectList magicTradeTier1 = new AspectList().add(Aspect.ORDER, 5);
	public static AspectList magicTradeTier2 = new AspectList().add(Aspect.ORDER, 10);
	public static AspectList magicTradeTier3 = new AspectList().add(Aspect.ORDER, 15);
	public static AspectList magicTradeTier4 = new AspectList().add(Aspect.ORDER, 20);
	public static AspectList magicTradeTier5 = new AspectList().add(Aspect.ORDER, 25);
	...
	public static AspectList chargerBlock = new AspectList().add(Aspect.AIR, 10).add(Aspect.ORDER, 10).add(Aspect.FIRE, 10).add(Aspect.WATER, 10);
	public static AspectList exchangerBlock = new AspectList().add(Aspect.AIR, 20).add(Aspect.ORDER, 20).add(Aspect.FIRE, 20).add(Aspect.WATER, 20);
	...
	public static AspectList destroyFoci = new AspectList().add(Aspect.MAGIC, 25).add(Aspect.ORDER, 10).add(Aspect.ENTROPY, 10).add(Aspect.DARKNESS, 10);
	public static AspectList cleanFoci = new AspectList().add(Aspect.MAGIC, 25).add(Aspect.ORDER, 10).add(Aspect.ENTROPY, 15).add(Aspect.DARKNESS, 15);
	...
	public static AspectList angelRod = new AspectList().add(Aspect.ORDER, 100).add(Aspect.ENTROPY, 100);
	public static AspectList devilRod = new AspectList().add(Aspect.ORDER, 125).add(Aspect.ENTROPY, 125);
	public static AspectList godRod = new AspectList().add(Aspect.ORDER, 250).add(Aspect.ENTROPY, 250);
	public static AspectList candyRod = new AspectList().add(Aspect.ORDER, 5).add(Aspect.ENTROPY, 5);
}
